...
try:
    ...
    # Tratamento para ler o JSON gerado no Windows sem quebrar no Docker
    # Docker usa naturalmente o Linux..
    try:
        texto_meta = METADATA_PATH.read_text(encoding="utf-8")
    except UnicodeDecodeError:
        texto_meta = METADATA_PATH.read_text(encoding="latin-1")
        
    metadata = json.loads(texto_meta)
